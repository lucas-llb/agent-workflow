...
- If E2E coverage for a required user journey is missing, return `needs fixes` and invoke `agent-test-engineer` to write the missing Playwright tests before re-running QA.
