...
- Template for task list: `~/.claude/templates/tasks-template.md`
- Task list: `./docs/tasks/prd-[feature-name]/tasks.md`
- Template for individual task: `~/.claude/templates/task-template.md`
- Individual tasks: `./docs/tasks/prd-[feature-name]/[num]_task.md`

### Task Summary Format (tasks.md)

- **STRICTLY FOLLOW THE TEMPLATE AT `~/.claude/templates/tasks-template.md`**

### Individual Task Format ([num]\_task.md)

- **STRICTLY FOLLOW THE TEMPLATE AT `~/.claude/templates/task-template.md`**
